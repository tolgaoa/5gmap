...
proxy_version=3.2.0 # Bi-directional interception proxy version
ndn_proxy_version=2.2.0 # NDN proxy version
init_version=3.0.0 # init container version for the sandbox manipulation

proxyon=true # switch on in case of either biproxy or ndnproxy
biproxyon=false # switch on if you are using vanilla SCP interception
ndnproxyon=true # switch on if you are using NDN routing
proxymode=NDN # specifcy the proxy mode -- HTTP1, HTTP2, HTTP3, NDN
usetls=false # not used
packetloss=0% # specify to induce artifical packet loss between VNFs
...
##----Data plane traffic generation--- Not used during NDN experimentation
